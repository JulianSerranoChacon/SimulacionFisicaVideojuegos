...
Generator::Generator(int maxParticles, double emisionVel, mVector3D genPos, mVector3D genPosOffset,mVector3D genVel, mVector3D genVelOffset, mVector3D genAccel,
...
void Generator::killParts(ParticleGen* particula)
{
